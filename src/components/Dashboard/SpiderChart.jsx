...
const SpiderChart = ({ 
  ...
  const getBangkokSpiderData = () => {
    ...
    return [
      { 
        ...
        fullMark: 100,
        informal_workers: 65, // Lower = more risk
        elderly: 75,
        disabled: 70,
        lgbtq: 68,
        overall: 72
      ...
      { 
        ...
        fullMark: 100,
        informal_workers: 40, // Most vulnerable
        elderly: 60,
        disabled: 45,
        lgbtq: 55,
        overall: 70
      ...
      { 
        ...
        informal_workers: 50,
        elderly: 65,
        disabled: 45, // Accessibility challenges
        lgbtq: 55,
        overall: 70
      },
      { 
  ...
  const getDistrictSpiderData = () => {
    // Sample data - replace with actual district-specific data
    return [
      { 
        domain: 'Health Behaviors', 
        fullMark: 100,
  ...
  const chartData = analysisLevel === 'bangkok' ? getBangkokSpiderData() : getDistrictSpiderData();
  ...
  const renderInsights = () => {
    if (analysisLevel === 'bangkok') {
      ...
      const overallScore = chartData.find(d => d.domain === 'Health Behaviors')?.overall || 0;
      const groupScore = chartData.find(d => d.domain === 'Health Behaviors')?.[selectedPopulationGroup] || 0;
      ...
      <div className={`p-4 rounded-lg border text-center ${
        ...
        <p className={`text-sm ${
          ...
          {analysisLevel === 'bangkok' 
            ...
            : `District-level analysis reveals local health equity gaps. Use this data to design community-specific health programs for ${selectedDistrict}.`
          }
        </p>
