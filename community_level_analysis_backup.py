...
2. Calculates mean scores for all 6 SDHE domains
...
def calculate_sdhe_scores(df):
    """
    Calculate all 6 SDHE domain scores for a given dataframe
    Returns the dataframe with score columns added
    """
    df = df.copy()
